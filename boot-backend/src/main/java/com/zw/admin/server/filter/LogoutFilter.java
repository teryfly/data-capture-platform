...
public class LogoutFilter extends org.apache.shiro.web.filter.authc.LogoutFilter {
	...
	private static String SUCCESS_INFO = JSONObject.toJSONString(new SuccessTip(HttpStatus.OK.value(), "退出成功"));
	private static String ERR_INFO = JSONObject
			.toJSONString(new SuccessTip(HttpStatus.BAD_REQUEST.value(), "退出失败,token不存在"));
