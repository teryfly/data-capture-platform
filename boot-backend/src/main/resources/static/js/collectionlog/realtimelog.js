...
Collectionlog.initColumn = function () {
    return [
        ...
        {title: '监听事件', field: 'monitoring_events_name', visible: true, align: 'center', valign: 'middle'},
        {title: '广播事件', field: 'broadcast_events_name', visible: true, align: 'center', valign: 'middle'},
        {title: '发送广播事件', field: 'sending_broadcast_events_name', visible: true, align: 'center', valign: 'middle'},
...
window.operateEvents1 = {
    'click .tabLook': function (e, value, row, index) {
        ...
        var index = layer.open({
            ...
            fix: false, //不固定
            maxmin: true,
            content: Feng.ctxPath + '/pages/collection/collectionlog/realtimecondition.html',
